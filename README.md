...
We used an LLM to assist with coding and refined our instructions multiple times to improve consistency between human and AI labeling. The final dataset includes classifications for each comment, reliability scores, and visualizations that summarize how support and criticism appear across the platform.

The included files contain our cleaned data, reliability results, graphs, and a written summary of findings.
